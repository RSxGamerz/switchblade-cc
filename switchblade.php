...
$botToken = "6938384771:AAG80sKhneDkzpq9DfkDU8eIvR1KlHdG0uU"; #<------------------- PUT YOUR TOKEN HERE------------->#
...
sendMessage ($chatId, "─ Dark x Carder Panel ─ %0A⁕ Registered as ➞ @$username %0A⁕ Use ➞ /cmds to show available commands. %0A⁕ Owner ➞ @pentagrvm | Update Logs ➞ @switchbladeupdate", $message_id);
}

// Cmds Commands
elseif ((strpos($message, "!cmds") === 0)||(strpos($message, "/cmds") === 0)){
sendMessage($chatId, "─ Dark x Carder Commands ─%0A%0A<b>➣ Stripe Charge/Auth [✅]</b>%0AUsage: <code>/chk cc|mm|yy|cvv</code>%0A%0A<b>➣ Check SK Key [✅]</b>%0AUsage: <code>/key sk_live</code>%0A%0A<b>➣ Check Info [✅]</b>%0AUsage: <code>/info</code>%0A%0A<b>➣ Check BIN Info [✅]</b>%0AUsage: <code>/bin xxxxxx</code>%0A%0AContact → <b>@pentagrvm</b>");
}
...
// Proxy Configuration
$rp1 = array(
    1 => '38.154.227.167:5868',
    2 => '185.199.229.156:7492',
    3 => '185.199.228.220:7300',
